...
import customGeneralColors from './custom/GeneralColors';
import customThumbnailTheme from './custom/Thumbnail';
...
import customBoardItemTheme from './custom/BoardItem';
import customBoardListCardTheme from './custom/BoardListCard';
import customMicroBoardTheme from './custom/MicroBoard';
...
export default (variables /* : * */ = variable) => {
  const theme = {
    ...
    'Custom.GeneralColors': {
      ...customGeneralColors(variables)
    },
    'Custom.Thumbnail': {
      ...customThumbnailTheme(variables)
    },
    'Custom.BoardItem': {
      ...customBoardItemTheme(variables)
    },
    'Custom.BoardListCard': {
      ...customBoardListCardTheme(variables)
    },
    'Custom.MicroBoard': {
      ...customMicroBoardTheme(variables)
    },
  };
